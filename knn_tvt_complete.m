...
for k = ks
    ...
    [pred, k_min_label, k_min_sample] = knn(val_digits, train_digits, train_labels, k, 'euclidean');
...
[pred, k_min_label, k_min_sample] = knn(test_digits, train_digits, train_labels, best_k, 'euclidean');
% 
% ******** step 2. ********
